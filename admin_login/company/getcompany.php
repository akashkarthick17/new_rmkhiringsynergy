                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 ">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" size="30" id="job-title" name="company_name"
                                           value="<?php echo $row['company_name'] ?>"/>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            <div>
                                <input type="hidden" id="job-id" name="company_id" value="<?php echo $row['company_id'] ?>"/>
                            </div>

                            <div class="form-group">
                                <label for="campus-date">Company Website</label>

                                <div>
                                    <input type="text" size="30" name="company_website" id="campus-date" value="<?php echo $row['company_website'] ?>"/>
                                </div>
                            </div>
                            <div class="space-4"></div>

                            <div class="form-group ">
                                <label for="salary">Comapany Description</label>

                                <div>
                                    <textarea rows="7"  cols="30" name="company_description" id="salary"> <?php echo $row['company_description'] ?></textarea>
                                </div>
                            </div>
