...
if(isset($_GET['job_id']) && isset($_SESSION['user_role'])=='admin' ){
...
if(isset($_POST['update_submit']) && isset($_SESSION['user_role'])=='admin' ) {
    ...
    $get_title = $_POST['submit_title'];
    $get_id= $_POST['submit_id'];
    $get_campus_date= $_POST['submit_campus_date'];
    ...
    if($get_company!=""){
        ...
        $select="SELECT company_name from company_list where company_id=$get_company";
        $result_select=mysqli_query($connect, $select);
        $select_row=mysqli_fetch_assoc($result_select);


        $query = "UPDATE jobs SET job_title='{$get_title}', company='{$select_row['company_name']}',campus_date='{$get_campus_date}', salary='{$get_salary}', venue='{$get_venue}', apply_before='{$get_apply_before}'   where job_id={$get_id}";
        ...
        $query = "UPDATE jobs SET job_title='{$get_title}',campus_date='{$get_campus_date}', salary='{$get_salary}', venue='{$get_venue}', apply_before='{$get_apply_before}'   where job_id={$get_id}";
...
<!-- /.ace-settings-container -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Jobs Panel</h3>

                                <div class="clearfix">
                                    <div class="pull-right tableTools-container"></div>
                                </div>
                                <div class="table-header">
                                    Results for "Jobs List"
                                </div>
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th>Jobs</th>
                                            <th>Company</th>
                                            <th class="hidden-480">Campus Date</th>
                                        ...
                                        while($row=mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-480"><?php  echo $campus_date ?></td>
                                    ...
                                    <?php
                                                    ...
                                                    ?>
                                                    <td class="hidden-480">
                                                        <span class="label label-sm label-danger"><?php echo $apply_before ?></span>
                                                    </td>
                                                    <?php
                                                }
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        ...
                                                        <a class="green" href="#modal-form" role="button"  data-toggle="modal" onclick="showUser(<?php  echo $row['job_id']   ?>)">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                ...
                                                                <li>
                                                                    <a href="#modal-form" class="tooltip-success" data-toggle="modal"
                                                                       data-rel="tooltip" title="Edit"  onclick="showUser(<?php  echo $row['job_id']   ?>)">
